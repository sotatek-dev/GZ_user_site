...
export enum Message {
	MINT_SUCCESS = 'You can collect your sdNFT 7 days after the end of Presale 2',
	...
	ELIGIBLE_TO_MINT = 'You are eligible to mint this sdNFT',
	ELIGIBLE_TO_CLAIM = 'You are eligible to claim this sdNFT',
	ELIGIBLE_TO_RESCUE = 'You are eligible to rescue this sdNFT',
	NOT_ELIGIBLE_TO_MINT = 'You are not eligible to mint this sdNFT',
	NO_NFT_LEFT = 'There is no sdNFT left to be rescued',
}
