            ...
            {timelineMintNft.map(
              (phaseInfo: ITimelineMintNftState, index: number) => {
                ...
                return (
                  ...
                  >
                    {/* line */}
                    {index !== l - 1 && <div className={'absolute left-[9px] top-6 border-r-2 border-green h-full'} />}

                    <div className={'relative z-20 flex justify-center items-center h-full py-0.5'}>
                      {renderIcon(status)}
                    </div>
