			...
			<div>
				<BoxPool>
					...
					<div className='mt-6'>
						...
						<MyTable columns={columns} dataSource={datafake} className={'hidden desktop:inline-block'}/>
									...
									<>
										<div className={'flex flex-col gap-6 mb-6'} key={item}>
											...
											<div className={'flex justify-between items-center'}>
												<div className={'text-h8 text-blue-20 font-medium'}>Species</div>
												<Link className={'text-h8 text-white font-bold'} href='/nft-detail'>{value.Species}</Link>
											</div>
											<div className={'flex justify-between items-center'}>
												<div className={'text-h8 text-blue-20 font-medium'}>Rarity</div>
												<Link className={'text-h8 text-white font-bold'} href='/nft-detail'>{value.Rarity}</Link>
											</div>
											<div className={'flex justify-between items-center'}>
												<div className={'text-h8 text-blue-20 font-medium'}>Claimable data</div>
												<Link className={'text-h8 text-white font-bold'} href='/nft-detail'>{value.Claimable_date}</Link>
											</div>
										</div>
									</>
								)
